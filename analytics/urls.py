...
urlpatterns = [
    ...
    path("reflections/history/", views.reflection_history_view, name="reflection_history"),
    ...
    path("api/reflections/", views.reflections_create_api_view, name="reflections_create"),
    path("api/reflections/<int:pk>/", views.reflections_update_api_view, name="reflections_update"),
    path("api/reflections/history/", views.reflections_history_api_view, name="reflections_history"),
]
